...
- [x] **Stores data in MongoDB** - I did complete this part of the deliverable and MongoDB is in use.
- [x] **Stores credentials in MongoDB** - I did complete this part of the deliverable and MongoDB is in use.
